...
<footer class="mt-8 bg-white shadow dark:bg-gray-800">
  <div class="container mx-auto px-4 py-8">
    <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
      <!-- About Section -->
      <div>
        <h3 class="mb-4 text-lg font-semibold">うぃーくりー・あんだーわーるど・にゅーす</h3>
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li>
            <a href="/blog" class="text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
              Blog
            </a>
          </li>
          <li>
            <a href="/about" class="text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
              About
            </a>
          </li>
        </ul>
    ...
    <div class="mt-8 border-t border-gray-200 pt-8 dark:border-gray-700">
      <p class="text-center text-gray-600 dark:text-gray-400">
        &copy; {currentYear} うぃーくりー・あんだーわーるど・にゅーす. All rights reserved.
      </p>
    </div>
  </div>
</footer> 
